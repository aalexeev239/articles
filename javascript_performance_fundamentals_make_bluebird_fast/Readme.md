...
_Примечание переводчика:_ базовые сведения о работе JavaScript-компилятора, понятия об инлайн-кэшировании и встраивании функций — в статье [Прошлое и будущее компиляции JavaScript](https://habrahabr.ru/post/182802/). О работе оптимизатора — в переводе [Убийцы оптимизации](https://habrahabr.ru/company/mailru/blog/273839/), оригинал которой тоже за авторством Петки Антонова.
