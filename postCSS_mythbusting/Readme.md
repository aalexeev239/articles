...
В дополнение к этому, PostCSS парсит как CSS, так и SCSS синтаксис. Это значит, что вы можете обрабатывать плагинами PostCSS свои `.scss` файлы. Как это делается — поговорим в следующем разделе.
